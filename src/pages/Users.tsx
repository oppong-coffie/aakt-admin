...
import { Search, Filter, ChevronDown, Plus, MoreHorizontal, User, CreditCard, Ban, X, Check } from 'lucide-react';
              ...
              <div key={user.id} className="grid grid-cols-6 gap-4 py-4 text-[13px] text-gray-600 border-b border-gray-50 relative items-center hover:bg-gray-50/50 transition-colors">
                ...
                <div className="relative">
                  <button 
                    onClick={(e) => {
                      e.stopPropagation();
                      setActiveActionRow(activeActionRow === user.id ? null : user.id);
                    }}
                  ...
                  {activeActionRow === user.id && (
                    <div ref={actionRef} className="absolute right-full top-0 mr-2 w-48 bg-white rounded-xl shadow-[0_4px_20px_-4px_rgba(0,0,0,0.1)] border border-gray-100 py-2 z-20">
            ...
            <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden relative animate-in fade-in zoom-in duration-200">
              <div className="p-6">
                ...
                <div className="flex flex-col gap-4">
                  <input type="text" placeholder="Name" className="w-full px-4 py-3 bg-gray-100 rounded-xl border-none focus:outline-none focus:ring-2 focus:ring-blue-500 text-[14px]" />
                  <input type="text" placeholder="Role" className="w-full px-4 py-3 bg-gray-100 rounded-xl border-none focus:outline-none focus:ring-2 focus:ring-blue-500 text-[14px]" />
