...
const Workloads = () => {
    ...
    return (
        <div className="p-8 bg-white min-h-full">
            <div className="mb-6">
                <h1 className="text-[28px] font-semibold text-gray-900 mb-6">Workloads</h1>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-200 min-h-[500px] overflow-visible">
                <h3 className="text-lg font-semibold text-gray-900 mb-6">All Workloads</h3>
                ...
                {loading ? (
                    ...
                    <div className="w-full">
                        {/* Table Header */}
                        <div className="grid grid-cols-8 gap-4 pb-4 text-[13px] font-semibold text-gray-900 border-b border-gray-200 min-w-[900px]">
                            <div>Name</div>
                            <div>Status</div>
                            <div>Tasks</div>
                            <div>User ID</div>
                        ...
                        <div className="flex flex-col min-w-[900px]">
                            {filteredWorkloads.map((workload) => {
                                ...
                                return (
                                    <div 
                                        key={workloadId} 
                                        className="grid grid-cols-8 gap-4 py-4 text-[13px] text-gray-600 border-b border-gray-100 items-center hover:bg-gray-50 transition-colors relative"
                                    >
                                        ...
                                        <div className="relative text-right">
                                            ...
                                            {activeActionRow === workloadId && (
                                                <div ref={actionRef} className="absolute right-0 top-full mt-1 w-48 bg-white rounded-xl shadow-[0_4px_20px_-4px_rgba(0,0,0,0.1)] border border-gray-100 py-2 z-50 text-left">
                                                    <button 
                                                        onClick={() => {
                                                        ...
                                                        className="w-full flex items-center gap-3 px-4 py-2.5 text-[13px] text-green-600 hover:bg-green-50 hover:text-green-700"
                                                    >
                                                        <Plus className="w-4 h-4" />
                                                        Add Task
                                                    </button>
                                                    <button 
                                                        ...
                                                        className="w-full flex items-center gap-3 px-4 py-2.5 text-[13px] text-blue-600 hover:bg-blue-50 hover:text-blue-700"
                                                    >
                        ...
                        <div className="p-6 space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-2.5 border border-gray-300 rounded-lg bg-white text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
                                    autoFocus
                                />
                            </div>
