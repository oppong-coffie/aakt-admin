...
import { LayoutDashboard, BarChart2, Briefcase, Users, HelpCircle, Settings, LogOut, CheckSquare } from 'lucide-react';
      ...
      <div className="p-4 dark:border-gray-700 flex flex-col gap-2">
        ...
        <ul className="flex flex-col gap-1 px-1">
          <li>
            <Link
              to="/landing"
              className={`flex items-center gap-3 px-3 rounded-xl text-[13px] font-medium transition-colors ${location.pathname === '/landing'
                ? 'bg-blue-50 text-blue-600 dark:bg-blue-900/20 dark:text-blue-400'
                : 'text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700/50 hover:text-gray-900 dark:hover:text-gray-200'
                }`}
            >
